...
const TestimonialParaOnly = () => {
  ...
  return (
    ...
    <main className='box-border flex lg:h-[40vh] xl:h-[38vh] overflow-x-hidden lg:w-[60vw] xl:w-[50vw] mx-auto'>
    ...
    {/* //! This div wraps all the content of the testimonial and inside it is the two sections, one is the image section and the other is the paragraph... */}
        ...
        <AnimatePresence custom={direction} mode={'popLayout'}>
            ...
            <motion.div 
            className='lg:flex-[80%] flex flex-col gap-10 lg:gap-0 lg:flex-row overflow-hidden' 
            ...
            animate="animate" 
            exit="exit" 
            transition={{x: { type: "spring", stiffness: 300, damping: 50 },
            ...
            <section className='flex'>
                ...
                <div className='flex flex-col justify-between h-[100%] w-[100%]'>
                    ...
                    <a className="inline-flex items-center">
                            <img alt="customer_image" src={testimonials[index].customerImage} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
                            <span className="flex-grow flex flex-col pl-4">
                                <span className="title-font text-gray-900 font-semibold">{testimonials[index].customerName}</span>
                                <span className="text-gray-400 text-xs tracking-widest mt-0.5">{testimonials[index].customerAbout}</span>
                            </span>
                    </a>
                </div>
        ...
        <section className='hidden flex-[20] lg:flex-[10%] lg:flex items-end justify-between px-3 z-10'>

            <button>
                <svg className='cursor-pointer fill-[#BEBEBE] hover:fill-[#080816] duration-300 ease-out' width="25" height="25" viewBox="0 0 29 29" fill="none" 
                    onClick={()=>paginate(-1)}>
...
export default TestimonialParaOnly;